...
def model_create(num_classes=23):
...
class ResNeXtManager:
    ...
    def __init__(self, ckpt_path, num_classes=23) -> None:
        ...
        self.model = model_create(num_classes=num_classes)
        self.num_classes = num_classes
    ...
    def async_save_wbc_image_feature_batch(self, image_paths):
        ...
        for i, image_path in enumerate(image_paths):
            ...
            os.makedirs(
                os.path.join(os.path.dirname(image_path), "features_imagenet"),
                exist_ok=True,
            )
