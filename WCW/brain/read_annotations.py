...
from WCW.brain.regex import says_peripheral_blood_smear, get_barcode_from_fname, last_date
...
def get_PB_metadata(wsi_fname, PB_annotations_df):
    ...
    print(barcode)
    print(PB_annotations_df['barcode'])
    df = PB_annotations_df[str(PB_annotations_df['barcode']) == barcode]
